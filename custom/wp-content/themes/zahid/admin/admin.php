...
<div class="box">
   ...
   <div class="content">
       <div id="htabs" class="htabs">
		   ...
		   <a href="#tab-footermenulink">Footer Menu</a>
		   <a href="#tab-aboutcompany">About Company</a>
			...
			<div id="tab-footer">
		        <table class="form">
				  ...
				  <tr>
				    ...
				    <tr>
				  	<td>footer info</td>
				  	<td><textarea cols="60" rows="4" name="setting[footerinfo]"><?php echo $zahid_theme_option['footerinfo'];?></textarea></td>
				    </tr>

			      <tr>
			    	<td>facebook link</td>
			    	<td><textarea cols="60" rows="4" name="setting[facebook]"><?php echo $zahid_theme_option['facebook'];?></textarea></td>
			      </tr>

			        <tr>
			      	<td>linked link</td>
			      	<td><textarea cols="60" rows="4" name="setting[linked-in]"><?php echo $zahid_theme_option['linked-in'];?></textarea></td>
			        </tr>

		          <tr>
		        	<td>twitter link</td>
		        	<td><textarea cols="60" rows="4" name="setting[twitter]"><?php echo $zahid_theme_option['twitter'];?></textarea></td>
		          </tr>

		            <tr>
		          	<td>google+ link</td>
		          	<td><textarea cols="60" rows="4" name="setting[google-plus]"><?php echo $zahid_theme_option['google-plus'];?></textarea></td>
		            </tr>
		    	...
		    	<div id="tab-footermenulink">
		            <table class="form">
		    		
		    		</table>
		    		<table class="list">
		    		   <thead><td><?php _e('Link Title '); ?></td><td><?php _e('Link details'); ?></td><td></td></thead>
		    		    <tbody>
		    			<?php
		    			...
		    			?>
		    		    <tr>
		    			   <td><input size="60" type="text" name="setting[link_title][]" value="<?php echo $link_title;?>" />
		    				</td>
		    			   <td><input size="60" type="text" name="setting[link_detail][]" value="<?php echo $link_detail;?>" /></td>
		    			...
		    			<tfoot>
		    			 <tr>
		    			   <td colspan="2">&nbsp;</td>
		    			  <td>&nbsp;<a class="button add-row" rel="link">Add New</a></td>
		    			 </tr>
		    		    </tfoot>
		        	...
		        	<div id="tab-aboutcompany">
		                <table class="form">
		        		 
		        		  <tr>
		        			<td>Sub Title</td>
		        			<td><textarea cols="60" rows="4" name="setting[subtitle]"><?php echo $zahid_theme_option['subtitle'];?></textarea></td>
		        		  </tr>

		        		    <tr>
		        		  	<td>Heading</td>
		        		  	<td><textarea cols="60" rows="4" name="setting[heading]"><?php echo $zahid_theme_option['heading'];?></textarea></td>
		        		    </tr>

	        		      <tr>
	        		    	<td>Company Description</td>
	        		    	<td><textarea cols="60" rows="4" name="setting[company-description]"><?php echo $zahid_theme_option['company-description'];?></textarea></td>
	        		      </tr>
		        		
		        		  
		        		  <tr>
		        			<td>Short info 1</td>
		        			<td><textarea cols="60" rows="4" name="setting[short-info1]"><?php echo $zahid_theme_option['short-info1'];?></textarea></td>
		        		  </tr>
		        		  
		        		    <tr>
		        		  	<td>Short info 1 text</td>
		        		  	<td><textarea cols="60" rows="4" name="setting[short-info1-text]"><?php echo $zahid_theme_option['short-info1-text'];?></textarea></td>
		        		    </tr>


		        		    <tr>
		        		  	<td>short info 2</td>
		        		  	<td><textarea cols="60" rows="4" name="setting[short-info2]"><?php echo $zahid_theme_option['short-info2'];?></textarea></td>
		        		    </tr>

		        		      <tr>
		        		    	<td>short info 2 text</td>
		        		    	<td><textarea cols="60" rows="4" name="setting[short-info2-text]"><?php echo $zahid_theme_option['short-info2-text'];?></textarea></td>
		        		      </tr>

		        	      <tr>
		        	    	<td>Video Link</td>
		        	    	<td><textarea cols="60" rows="4" name="setting[video-link]"><?php echo $zahid_theme_option['video-link'];?></textarea></td>
		        	      </tr>
