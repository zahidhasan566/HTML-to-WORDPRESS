...
?>
  ...
  <section class="banner-section">
      ...
      <div class="owl-stage-outer owl-height" style="height: 916px;"><div class="owl-stage" style="transform: translate3d(-4047px, 0px, 0px); transition: all 0s ease 0s; width: 9443px;"><div class="owl-item cloned" style="width: 1349px;"><div class="slide" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/image-1.jpg)">
        ...
        </div></div><div class="owl-item cloned" style="width: 1349px;"><div class="slide" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/image-1.jpg)">
          <div class="patern-layer-one" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/pattern-1.png)"></div>
          <div class="patern-layer-two" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/pattern-2.png)"></div>
          <div class="auto-container">
        ...
        </div></div><div class="owl-item" style="width: 1349px;"><div class="slide" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/image-1.jpg)">
          <div class="patern-layer-one" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/pattern-1.png)"></div>
          <div class="patern-layer-two" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/pattern-2.png)"></div>
          <div class="auto-container">
        ...
        </div></div><div class="owl-item active" style="width: 1349px;"><div class="slide" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/image-1.jpg)">
          <div class="patern-layer-one" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/pattern-1.png)"></div>
          <div class="patern-layer-two" style="background-image: url(<?php bloginfo('template_url'); ?>/images/main-slider/pattern-2.png)"></div>
          <div class="auto-container">
        ...
        </div></div></div></div><div class="owl-nav"><div class="owl-prev"><span class="flaticon-back-1"></span></div><div class="owl-next"><span class="flaticon-arrow-pointing-to-right"></span></div></div><div class="owl-dots"><div class="owl-dot"><span></span></div><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div></div></div>
      ...
      <div class="row clearfix">
        ...
        <div class="content-column col-lg-6 col-md-12 col-sm-12">
          <div class="inner-column">
            ...
            <a href="https://www.youtube.com/watch?v=kxPCFljwJws" class="lightbox-image theme-btn btn-style-one"><span class="txt"><i class="play-icon"><img src="<?php bloginfo('template_url'); ?>/images/icons/play-icon.png" alt="" /></i>&ensp; intro Video</span></a>
  ...
  <section class="call-to-action-section" style="background-image: url(<?php bloginfo('template_url'); ?>/images/background/pattern-3.png)">
    <div class="auto-container">
      <div class="row clearfix">
        <!-- Heading Column -->
    ...
    <div class="auto-container">
      ...
      <div class="clearfix">
        ...
        <div class="team-block col-lg-3 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image">
              <a href="team.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/team-1.jpg" alt="" /></a>
            </div>
            <div class="lower-box">
              <!-- Social Box -->
              <ul class="social-box">
        ...
        <div class="team-block col-lg-3 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image">
              <a href="team.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/team-2.jpg" alt="" /></a>
            </div>
            <div class="lower-box">
              <!-- Social Box -->
              <ul class="social-box">
        ...
        <div class="team-block col-lg-3 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image">
              <a href="team.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/team-3.jpg" alt="" /></a>
            </div>
            <div class="lower-box">
              <!-- Social Box -->
              <ul class="social-box">
        ...
        <div class="team-block col-lg-3 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image">
              <a href="team.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/team-4.jpg" alt="" /></a>
            </div>
            <div class="lower-box">
              <!-- Social Box -->
              <ul class="social-box">
    ...
    <div class="auto-container">
      ...
      <div class="row clearfix">
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image">
              <a href="news-detail.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/news-1.jpg" alt="" /></a>
            </div>
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image">
              <a href="news-detail.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/news-2.jpg" alt="" /></a>
            </div>
            <div class="lower-content">
        ...
        <div class="news-block col-lg-4 col-md-6 col-sm-12">
          <div class="inner-box">
            <div class="image">
              <a href="news-detail.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/news-3.jpg" alt="" /></a>
            </div>
            <div class="lower-content">
