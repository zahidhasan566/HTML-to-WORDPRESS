              ...
              <div class="footer-column col-lg-6 col-md-6 col-sm-12">
                <div class="footer-widget news-widget">
                  ...
                  <div class="widget-content">
                    <div class="post">
                      <div class="thumb"><a href="news-detail.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/post-thumb-3.jpg" alt=""></a></div>
                      <h6><a href="news-detail.html">Define World Best IT Solution Technology</a></h6>
                      <span class="date">May 01, 2020</span>
                    </div>

                    <div class="post">
                      <div class="thumb"><a href="news-detail.html"><img src="<?php bloginfo('template_url'); ?>/images/resource/post-thumb-4.jpg" alt=""></a></div>
        ...
        <div class="auto-container">
          <div class="row clearfix">
            ...
            <div class="column col-lg-6 col-md-12 col-sm-12">
              <div class="copyright">Copyright &copy; 2020 by expert-themes. All Rights Reserved.</div>
            </div>
            <!-- Column -->
            <div class="column col-lg-6 col-md-12 col-sm-12">
              <ul class="footer-nav">
...
<!-- Mirrored from expert-themes.com/html/globex/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Dec 2020 01:37:54 GMT -->
</html>